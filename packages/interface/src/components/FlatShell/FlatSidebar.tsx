...
import { Link, useRouter } from "@polarhq/interface/lib/router"
import logo from "../../assets/logo.png"
import { authClient } from "@polarhq/sdk/authClient"
import { lockKeys } from "@polarhq/vault/e2e"
import { fetchStorageStats } from "@polarhq/vault/drive"
...
import { setSearchQuery } from "@polarhq/interface/store/uiSlice"
import { applyThemeWithReveal } from "@polarhq/interface/lib/themeTransition"
import {
  IconChevronDown,
  IconLogout,
  IconMoon,
...
import Changelog from "@polarhq/interface/components/Changelog/Changelog"
import DevicesDialog from "@polarhq/interface/components/DevicesDialog/DevicesDialog"
import StorageDialog from "@polarhq/interface/components/StorageDialog/StorageDialog"
import { replayOnboarding } from "@polarhq/interface/components/OnboardingCard/OnboardingCard"
    ...
    <Sidebar collapsible="offcanvas">
      <div className="border-border flex h-14 shrink-0 items-center border-b px-3">
        ...
        >
          <span className="flex size-7 shrink-0 items-center justify-center overflow-hidden rounded-md">
            <img src={logo} alt={sdkConfig().appName} width={28} height={28} className="size-7" />
          </span>
          <span className="truncate text-sm font-semibold">{sdkConfig().appName}</span>
          {beta ? (
      ...
      <div className="flex flex-col gap-2 p-3 pt-2">
        ...
        <div className="px-1 pt-0.5 text-center">
          <Changelog version={sdkConfig().version} build={sdkConfig().build} />
        </div>
