...
import Inspector, { type InspectorTab } from "@polarhq/interface/components/Inspector/Inspector"

const PhotoLocationMap = dynamic(
  () => import("@polarhq/interface/screens/Photos/components/PhotoLocationMap/PhotoLocationMap"),
)
