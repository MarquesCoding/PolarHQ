// Generates packages/core/src/changelog/releases.generated.ts from the repo-root CHANGELOG.md.
// Run via `pnpm --filter @polarhq/core changelog:generate`. CHANGELOG.md is the single source
...
const OUT = resolve(here, "../src/changelog/releases.generated.ts")
